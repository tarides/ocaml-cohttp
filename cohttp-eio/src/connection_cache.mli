(** This module establishes a new connection for each request. *)
module No_cache : sig
  include S.Connection_cache

  val create : unit -> t
  (** [create conn] creates a connection for handling a single request. The
...
(** This module keeps a cache of connections for reuse. Connections are reused
